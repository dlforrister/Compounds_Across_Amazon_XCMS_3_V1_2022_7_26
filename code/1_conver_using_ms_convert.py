...
os.chdir("W:\DF_LAB_FILES\CODE_GIT_HUB_2017_Aug_31\Compounds_Across_Amazon_XCMS_3_V1_2022_7_26")
uplc_results=pd.read_csv("./data/text_xcms.csv")
uplc_results


converted_path="W:\\Lab_Map\\Database\\2015_Relational_DB\\DATA_STORAGE\\UPLC_MS_DATA\\Data_Not_Active_Projects_etc\\10_Converted_Data\\Ecuador_Amazon\\"
raw_path= "W:\\Lab_Map\\Database\\2015_Relational_DB\\DATA_STORAGE\\UPLC_MS_DATA\\8_Active_Projects/Ecuador_Amazon.PRO\\Data\\"
...
msconvert = msconver_exe + ' --mzXML --32 --zlib --filter "msLevel 0-2" '
...
for index, row in uplc_results.iterrows():
    ...
    if not os.path.exists(output+ "\\"+uplc_file_to_convert + ".mzXML"):
        try:
            mzxml_path = "-o " + output
